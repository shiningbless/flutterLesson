...
class ProductRepository {
  static final List<ProductState> _allProductStates = <ProductState>[
    ProductState(
  ...
  static List<ProductState> loadProducts(ProductCategory category) {
    if (category == ProductCategory.all) {
      return _allProductStates;
    } else {
      return _allProductStates.where((product) => product.category == category).toList();
    }
  }
}
